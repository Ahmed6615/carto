...
var poteau = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Numero</th><td>" + feature.properties.Text + "</td></tr>"   +"<table>";
      layer.on({
        click: function (e) {
          $("#feature-title").html(feature.properties.Text);
      ...
      poteauSearch.push({
        name: layer.feature.properties.Text,
        source: "poteau",
        id: L.stamp(layer),
...
$.getJSON("data/ONUS.geojson", function (data) {
  poteau.addData(data);
